...
import { X, Download, Printer, CreditCard, Building2, Calendar, User, FileText } from 'lucide-react';
...
${index + 1}. ${item.name}
   ${item.quantity && item.unitPrice ? `Số lượng: ${item.quantity} ${item.unit || ''} x ${formatCurrency(item.unitPrice)}` : ''}
      ...
      <div className="bg-white rounded-lg shadow-xl max-w-4xl w-full max-h-[95vh] overflow-hidden">
        ...
        <div className="bg-gradient-to-r from-green-600 to-green-700 px-6 py-4 flex items-center justify-between print:hidden">
          <div>
            ...
            <p className="text-sm text-green-100 mt-1">Kỳ thanh toán {invoice.period}</p>
          </div>
          <button
            onClick={onClose}
        ...
        <div className="overflow-y-auto max-h-[calc(95vh-180px)]">
          ...
          <div className="px-8 py-6 border-b border-gray-200">
            <div className="text-center mb-6">
              <h1 className="text-2xl text-gray-900 mb-2">CHUNG CƯ SUNSHINE CITY</h1>
              <p className="text-sm text-gray-600">Địa chỉ: 123 Đường ABC, Quận XYZ, TP. Hồ Chí Minh</p>
              <p className="text-sm text-gray-600">Điện thoại: 028-1234-5678 | Email: info@sunshinecity.vn</p>
            </div>

            <div className="text-center mb-6">
              <h2 className="text-xl text-gray-900 mb-1">HÓA ĐƠN THANH TOÁN PHÍ QUẢN LÝ</h2>
              <p className="text-sm text-gray-600">Mã hóa đơn: <span className="text-blue-600">{invoice.id}</span></p>
            </div>
              ...
              <div>
                <div className="flex items-start gap-3 mb-3">
                  ...
                  <div>
                    ...
                    <p className="text-lg text-gray-900">{invoice.apartmentNumber}</p>
                  </div>
                </div>
                <div className="flex items-start gap-3 mb-3">
          ...
          <div className="px-8 py-6">
            <h3 className="text-lg text-gray-900 mb-4">Chi tiết các khoản thu</h3>
            <div className="overflow-x-auto">
              <table className="w-full border-collapse">
                <thead>
                  <tr className="border-b-2 border-gray-300">
                    <th className="text-left py-3 px-2 text-sm text-gray-700">STT</th>
                    <th className="text-left py-3 px-2 text-sm text-gray-700">Khoản thu</th>
                    <th className="text-center py-3 px-2 text-sm text-gray-700">Số lượng</th>
                    <th className="text-right py-3 px-2 text-sm text-gray-700">Đơn giá</th>
                    <th className="text-right py-3 px-2 text-sm text-gray-700">Thành tiền</th>
                  </tr>
                </thead>
                <tbody>
                  {invoice.details.map((item, index) => (
                ...
                <tfoot>
                  <tr className="border-t-2 border-gray-300">
                    <td colSpan={4} className="py-4 px-2 text-right text-lg text-gray-900">
                      Tổng cộng:
                    </td>
            ...
            <div className="mt-6 p-4 bg-yellow-50 border border-yellow-200 rounded-lg">
              <p className="text-sm text-gray-700">
                <span className="text-yellow-700">⚠️ Lưu ý:</span> Vui lòng thanh toán đầy đủ trước ngày <span className="text-red-600">{invoice.dueDate}</span> để tránh phát sinh phí chậm thanh toán.
              </p>
            </div>
          </div>
          ...
          <div className="px-8 py-6 bg-gray-50 border-t border-gray-200 print:hidden">
            <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
              ...
              <div className="bg-white rounded-lg border-2 border-green-200 p-6 text-center">
                <h4 className="text-lg text-gray-900 mb-4">Thanh toán qua QR Code</h4>
                ...
                <p className="text-xs text-gray-500">Hỗ trợ: MoMo, ZaloPay, VNPay, Banking</p>
              </div>

              {/* Payment Info */}
              <div className="bg-white rounded-lg border-2 border-blue-200 p-6">
                <h4 className="text-lg text-gray-900 mb-4">Thông tin chuyển khoản</h4>
                <div className="space-y-3">
                  <div className="flex items-start gap-3 pb-3 border-b border-gray-200">
                    ...
                    <div className="flex-1">
                      ...
                      <p className="text-sm text-gray-900">Vietcombank - Chi nhánh Tân Bình</p>
                    </div>
                  </div>
                  <div className="flex items-start gap-3 pb-3 border-b border-gray-200">
                    ...
                    <div className="flex-1">
                      ...
                      <p className="text-sm text-gray-900">0123456789</p>
                    </div>
                  </div>
                  <div className="flex items-start gap-3 pb-3 border-b border-gray-200">
                    ...
                    <div className="flex-1">
                      ...
                      <p className="text-sm text-gray-900">Ban Quản Lý Chung Cư Sunshine City</p>
                    </div>
                  </div>
                  <div className="flex items-start gap-3">
                    ...
                    <div className="flex-1">
                      ...
                      <p className="text-sm text-gray-900 break-all">{invoice.apartmentNumber} {invoice.period}</p>
                    </div>
                  </div>
                </div>
              </div>
            ...
            <div className="mt-4 p-4 bg-blue-50 border border-blue-200 rounded-lg">
              <p className="text-sm text-blue-900">
                💡 <span className="text-blue-700">Mẹo:</span> Vui lòng ghi đúng nội dung chuyển khoản để hệ thống tự động cập nhật thanh toán của bạn.
              </p>
            </div>
          </div>
          ...
          <div className="px-8 py-6 border-t border-gray-200 bg-gray-50">
            <div className="text-center text-sm text-gray-600">
              ...
              <p className="mt-1">Mọi thắc mắc vui lòng liên hệ: 028-1234-5678 | info@sunshinecity.vn</p>
            </div>
          </div>
        </div>
