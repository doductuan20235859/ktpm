                  ...
                  <div className="flex items-start justify-between mb-2">
                    ...
                    <div className="text-right flex items-start gap-3">
                      <div>
                        ...
                        <p className="text-lg text-red-600">{formatCurrency(invoice.totalAmount - invoice.paidAmount)}</p>
                      </div>
                      <button
                        onClick={(e) => {
                          e.stopPropagation();
        ...
        <div className="fixed inset-0 bg-black bg-opacity-50 flex items-center justify-center z-50">
          <div className="bg-white rounded-lg shadow-xl p-8 max-w-md text-center">
            ...
            <div className="bg-gray-50 rounded-lg p-4">
              <p className="text-sm text-gray-600">Căn hộ: <span className="text-gray-900">{searchedApartmentCode}</span></p>
            ...
            <div className="p-6 overflow-y-auto max-h-[calc(90vh-180px)]">
              ...
              <div className="grid grid-cols-3 gap-4 mb-6 bg-gray-50 p-4 rounded-lg">
                ...
                <div>
                  ...
                  <p className="text-sm text-gray-900">{selectedInvoiceDetail.period}</p>
                </div>
                <div>
              ...
              <div className="border-t border-gray-200 pt-4">
                <div className="flex justify-between items-center mb-2">
                  ...
                  <span className="text-gray-900">{formatCurrency(selectedInvoiceDetail.totalAmount)}</span>
                </div>
                <div className="flex justify-between items-center mb-2">
                  <span className="text-gray-600">Đã thanh toán:</span>
                  <span className="text-green-600">{formatCurrency(selectedInvoiceDetail.paidAmount)}</span>
                </div>
                <div className="flex justify-between items-center text-lg pt-2 border-t border-gray-200">
                  ...
                  <span className="text-red-600">{formatCurrency(selectedInvoiceDetail.totalAmount - selectedInvoiceDetail.paidAmount)}</span>
                </div>
              </div>
            </div>
